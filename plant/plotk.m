...
for i = 1:length(K_out.Time)
   K_data11(i) = K_out.Data(1,1,i);
   K_data14(i) = K_out.Data(4,1,i);
   K_data21(i) = K_out.Data(1,2,i);
   K_data24(i) = K_out.Data(4,2,i); 
end
...
subplot(2,1,1);
p(1) = plot(K_out.Time, K_data11, '-r', 'LineWidth',1.5); hold on;
p(2) = plot(K_out.Time, K_data14, '-b', 'LineWidth',1.5); hold on;
...
subplot(2,1,2);
p(1) = plot(K_out.Time, K_data21, '-r', 'LineWidth',1.5); hold on;
p(2) = plot(K_out.Time, K_data24, '-b', 'LineWidth',1.5); hold on;
